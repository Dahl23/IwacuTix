...
const DEPRECATED_TICKET_CODES: Record<string, string> = {
  ...
  token_expire: 'Ce lien de vérification a expiré. Demandez-en un nouveau.',
  token_invalide: 'Ce lien de vérification est invalide.',
  otp_expire: 'Ce code OTP a expiré. Demandez-en un nouveau.',
  otp_invalide: 'Code OTP incorrect.',
  otp_tentatives_epuisees: 'Trop de tentatives OTP échouées. Demandez un nouveau code.',
